...
class TestAD5676Device(object):
    ...
    def test_input_register_write(self, test_ad5676_device):
        ...
        test_ad5676_device.device.spi.writebytes2.assert_called_with(bytes([0x11, 0xff, 0xff]))
    ...
    def test_input_into_dac(self, test_ad5676_device):
        ...
        test_ad5676_device.device.spi.writebytes2.assert_called_with(bytes([0x20, 0x00, 0x23]))
    ...
    def test_write_to_dac(self, test_ad5676_device):
        ...
        test_ad5676_device.device.spi.writebytes2.assert_called_with(bytes([0x31, 0xFF, 0xFF]))
    ...
    def test_power_down(self, test_ad5676_device):
        ...
        test_ad5676_device.device.spi.writebytes2.assert_called_with(bytes([0x40, 0xCC, 0xCC]))
    ...
    def test_LDAC_mask_register(self, test_ad5676_device):
        ...
        test_ad5676_device.device.spi.writebytes2.assert_called_with(bytes([0x50, 0x00, 0xCC]))
    ...
    def test_software_reset(self, test_ad5676_device):
        ...
        test_ad5676_device.device.spi.writebytes2.assert_called_with(bytes([0x60, 0x12, 0x34]))
    ...
    def test_register_readback(self, test_ad5676_device):
        ...
        test_ad5676_device.device.spi.writebytes2.assert_called_with(bytes([0x91,0x00, 0x00]))
        test_ad5676_device.device.spi.xfer2.assert_called_with(bytes([0x00, 0x00, 0x00]))
    ...
    def test_update_all_input_channels(self, test_ad5676_device):
        ...
        test_ad5676_device.device.spi.writebytes2.assert_called_with(bytes([0xA0, 0xFF, 0xFF]))
    ...
    def test_update_all_dac_input_channels(self, test_ad5676_device):
        ...
        test_ad5676_device.device.spi.writebytes2.assert_called_with(bytes([0xB0, 0xFF, 0xFF]))
