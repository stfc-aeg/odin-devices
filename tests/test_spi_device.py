...
class TestSPIDevice(object):
    ...
    def test_buffer_or_data(self, test_spi_device):
        ...
        # With data -- so buffer is not used
    ...
    def test_write_n(self, test_spi_device):
        # Ensuring that the convenience functions are cutting data correctly
...
class TestSPIDeviceNoneWrites(object):

    def test_none_writes(self, test_spi_device):
        test_spi_device.device.disable_exceptions()
        test_spi_device.device.spi.reset_mock()
